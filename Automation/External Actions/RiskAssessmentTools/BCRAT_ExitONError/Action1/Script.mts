Dim strURL
Dim strEnvironment 
Dim strResultFiveYr, strResultLifeTime,ErrorFladg
...
boolExist=Browser("micclass:=Browser").Page("micclass:=Page").webElement("html tag:=DIV","class:=nwcontent").Exist
	...
	.WebList("subrace").Select "Japanese"
...
End With
 ...
 Msgbox "Could not find the BCRAT Page for without the children criteria"
...
End With
 ...
 Msgbox "Could not find the BCRAT Page for with children criteria"
